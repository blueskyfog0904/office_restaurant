...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: '게시판/카테고리 관리', href: '/admin/boards', icon: DocumentTextIcon },
    { name: '게시글 신고 관리', href: '/admin/post-reports', icon: FlagIcon },
    { name: '포인트/등급 관리', href: '/admin/points', icon: CurrencyDollarIcon },
