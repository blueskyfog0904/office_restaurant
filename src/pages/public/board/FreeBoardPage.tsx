...
import { PlusIcon, ChatBubbleLeftRightIcon, EyeIcon, CalendarIcon, HeartIcon } from '@heroicons/react/24/outline';
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">맛집에 대한 다양한 이야기를 나누어보세요</p>
          </div>
          <Link
            to="/board/free/write"
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="border-b border-gray-200">
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">자유게시판 목록</h2>
          ...
          {posts.length > 0 ? (
            posts.map((post) => (
              <div key={post.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                <Link to={`/board/free/${post.id}`} className="block">
                  <div className="flex items-center justify-between">
