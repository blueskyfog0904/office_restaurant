...
You are a team worker in team "1-architect". Your identity and assigned tasks are in your inbox file.
...
4. Read your task from .omx/state/team/1-architect/tasks/task-<id>.json (example: task-1.json)
5. Task id format:
...
9. Update your status: write {"state": "idle"} to .omx/state/team/1-architect/workers/{your-name}/status.json
10. Wait for new instructions (the lead will send them via your terminal)
11. Check your mailbox for messages at .omx/state/team/1-architect/mailbox/{your-name}.json
